...
*文件名：  HttpMethods 
*版本号：  V1.0.0.0
*唯一标识：7c071989-09f0-46e4-b8de-4cf9e4b4431b
*当前的用户域：DESKTOP-FUHBS8L
*创建人：  Rex
*电子邮箱：
*创建时间：2017/9/6 16:01:51 

*描述：
*
*=====================================================================
*修改标记
*修改时间：2017/9/6 16:01:51 
*修改人： HY-REX 
*版本号： V1.0.0.0
*描述：
*
...
namespace Zeus.Core
{
    public class HttpMethods
    {
        ...
        public static string BuildRequest(string strUrl, Dictionary<string, string> dicPara, string fileName)
        {
            ...
            {
                var log = LogFactory.GetLogger(new System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name);
